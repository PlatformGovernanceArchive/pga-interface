      ...
      <Fragment>
        ...
        >
          <Nav className="flex-column">
            <Nav.Item>
              <Link to="/explore">Explore all policies</Link>
            </Nav.Item>
            ...
            <Nav.Item>
              <Link to="/ticker">Update ticker</Link>
            </Nav.Item>
            <Nav.Item>
              <Link to="/research">Data and Research</Link>
            </Nav.Item>
            <Nav.Item className="divider" />
            <Nav.Item>
              <a href="https://www.hiig.de/en/project/platform-governance-and-copyright/">
                Visit project website
              </a>
            </Nav.Item>
            <Nav.Item>
              <a href="https://www.hiig.de/en/imprint/">Imprint</a>
            </Nav.Item>
            <Nav.Item>
              <a href="https://www.hiig.de/en/data-protection-policy/">
